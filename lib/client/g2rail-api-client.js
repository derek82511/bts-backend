...
apiClient.searchOnlineSolutions = async function (from, to, date, time, duration, adult, child) {
    const params = new Map([
        ['from', from],
        ['to', to],
        ['date', date],
...
apiClient.bookOnlineOrder = async function (order) {
...
apiClient.confirmOnlineOrder = async function (onlineOrderId) {
    const params = new Map([
...
apiClient.downloadOnlineOrderTickets = async function (onlineOrderId) {
    const params = new Map([
        ['online_order_id', onlineOrderId],
    ])
...
apiClient.refundOnlineOrder = async function (onlineOrderId) {
    const params = new Map([
        ['online_order_id', onlineOrderId],
    ])
